# Brainboot a pelican theme

Brainboot is a theme based on gilsondev's [pelican version] (https://github.com/gilsondev/pelican-clean-blog) of the clean blog template by [start bootstrap] (https://github.com/IronSummitMedia/startbootstrap-clean-blog).
